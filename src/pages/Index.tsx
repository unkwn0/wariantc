...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Jak długo czeka się na wykonanie nagrobka?", "acceptedAnswer": { "@type": "Answer", "text": "Termin realizacji ustalamy indywidualnie. Zależy on od wybranego projektu, materiału oraz aktualnej liczby zamówień. Skontaktuj się z nami, aby uzyskać aktualny termin." } },
