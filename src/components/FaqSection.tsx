...
const faqs = [
  ...
  { q: 'Jak długo czeka się na wykonanie nagrobka?', a: 'Termin realizacji ustalamy indywidualnie. Zależy on od wybranego projektu, materiału oraz aktualnej liczby zamówień. Skontaktuj się z nami, aby uzyskać aktualny termin.' },
