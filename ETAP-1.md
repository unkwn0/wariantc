...
- `Header`: niezawijany numer telefonu, pola przycisków minimum 44 px, menu oparte na już zainstalowanym Radix Dialog (fokus, Escape, blokada tła, powrót fokusu), telefon w menu i zamknięcie po wyborze sekcji. Pełna nawigacja od 1280 px, aby uniknąć ciasnego układu na tabletach. Na najwęższym telefonie ukryto wyłącznie ikonę telefonu, nie numer.
